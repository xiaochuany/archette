...
\begin{align\*}
Y_t &= \sigma_t W_t \\
\sigma_t^2 &=  \omega + \alpha Y\_{t-1}^2 + \beta \sigma^2\_{t-1} 
\end{align\*}
$$
...
*σ̂*<sub>*t*</sub><sup>2</sup> = *ω̂* + *α̂* + *β̂**σ̂*<sub>*t* − 1</sub><sup>2</sup>

which depends entirely on the unobserved *σ*<sub>0</sub><sup>2</sup>.
